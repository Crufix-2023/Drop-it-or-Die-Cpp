...
/* randi()
вызов рандома int чисел: randi(abc, 0, 1001); | где randi() - функция, abc - переменная в которую запишется рандомное число, 0 - минимальное число, а 1001 - максимальное.
                                              | переменные и минимальные/максимальные числа можно стаивть любые(для randi только целые числа)
*/

/* randsh()
вызов рандома short чисел: randi(abc, 0, 1001); | где randsh() - функция, abc - переменная в которую запишется рандомное число, 0 - минимальное число, а 1001 - максимальное.
                                                | переменные и минимальные/максимальные числа можно стаивть любые(для randsh только целые числа)
*/

/* randf()
вызов рандома float чисел: randf(abc, 0.46, 1001.21); | где randf() - функция, abc - переменная в которую запишется рандомное число, 0.46 - минимальное число, а 1001.21 - максимальное.
                                                      | переменные и минимальные/максимальные числа можно стаивть любые(для randsh только целые числа)
*/
